...
const socialIcons = [
  { src: "https://c.animaapp.com/mo857b66QKlwSd/img/social-icons.png", alt: "X" },
  { src: "https://c.animaapp.com/mo857b66QKlwSd/img/social-icons-1.png", alt: "Facebook" },
  { src: "https://c.animaapp.com/mo857b66QKlwSd/img/social-icons-2.png", alt: "LinkedIn" },
];
...
export const ContactCalloutSection = (): JSX.Element => {
  ...
  return (
    <div className="w-full">
      ...
      {/* ══════════════════════════════════════
          CONTACT SECTION
          Figma: SVG bg, form left ~736 px, photo right 872×693 px
          ══════════════════════════════════════ */}
      <div
      ...
      >
        ...
        <img
          ...
          aria-hidden="true"
          alt=""
          src="https://c.animaapp.com/mo857b66QKlwSd/img/rectangle-9521.svg"
        />
        {/* Inner decoration */}
        <div className="absolute inset-x-0 top-14 bottom-0 pointer-events-none" aria-hidden="true">
          <img
            ...
            alt=""
            src="https://c.animaapp.com/mo857b66QKlwSd/img/rectangle-9492.svg"
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start">
            ...
            >
              <div className="flex flex-col gap-4">
                <img
                  ...
                  alt="Let&#39;s Connect"
                  src="https://c.animaapp.com/mo857b66QKlwSd/img/heading.svg"
                />
            ...
            >
              <img
                ...
                src="https://c.animaapp.com/mo857b66QKlwSd/img/rectangle-9477.png"
              />
            </div>
      ...
      {/* ══════════════════════════════════════
          ...
          Figma: 480 px tall at 1920 px wide
          ══════════════════════════════════════ */}
      <footer className="w-full bg-[#013870]" aria-label="Site footer">
        <div className="max-w-[1728px] mx-auto px-6 md:px-16 lg:px-24 pt-12 md:pt-[69px] pb-8 md:pb-10">
          ...
          {/* Grid: brand | quick links | categories | contact */}
          <div className="flex flex-col md:flex-row flex-wrap gap-10 md:gap-8 lg:justify-between">
            ...
            <div className="flex flex-col gap-8 w-full md:w-80 lg:w-96">
              <img
                ...
                alt="ICS Global logo"
                src="https://c.animaapp.com/mo857b66QKlwSd/img/ics-png-2-1.png"
              />
            ...
            <div className="flex flex-wrap gap-8 lg:gap-12 xl:gap-16 flex-1 lg:justify-end">
              ...
              <div className="flex flex-col gap-4 min-w-[180px] max-w-[237px]">
                ...
                {popularCategories.map((cat) => (
                  <div
                    key={cat}
                    className="[font-family:'Poppins',Helvetica] font-medium text-white text-sm md:text-base leading-6 cursor-pointer hover:opacity-80 transition-opacity"
                  >
                    {cat}
                  </div>
                ))}
