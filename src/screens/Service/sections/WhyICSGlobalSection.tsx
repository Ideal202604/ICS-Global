...
const socialIcons = [
  { src: "https://c.animaapp.com/mo863n0tfCwuCJ/img/social-icons.png", alt: "X" },
  { src: "https://c.animaapp.com/mo863n0tfCwuCJ/img/social-icons-1.png", alt: "Facebook" },
  { src: "https://c.animaapp.com/mo863n0tfCwuCJ/img/social-icons-2.png", alt: "LinkedIn" },
];

export const WhyICSGlobalSection = (): JSX.Element => {
    ...
    <div className="w-full">
      ...
      <div className="relative w-full overflow-hidden">
        <img
          ...
          alt=""
          aria-hidden="true"
          src="https://c.animaapp.com/mo863n0tfCwuCJ/img/rectangle-9491.svg"
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start">
            ...
            >
              <div className="flex flex-col gap-4">
                <img
                  ...
                  alt="Get in touch"
                  src="https://c.animaapp.com/mo863n0tfCwuCJ/img/heading.svg"
                />
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-4">
                  <img
                    ...
                    alt="Country code"
                    src="https://c.animaapp.com/mo863n0tfCwuCJ/img/frame-1321316631.svg"
                  />
            ...
            <div className="w-full min-h-[300px] md:min-h-[480px] rounded-2xl overflow-hidden hidden lg:block">
              <img
                ...
                src="https://c.animaapp.com/mo863n0tfCwuCJ/img/rectangle-9477.png"
              />
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row flex-wrap gap-10 md:gap-8 lg:justify-between">
            ...
            <div className="flex flex-col gap-6 w-full md:w-64 lg:w-80">
              <img
                ...
                alt="ICS Global"
                src="https://c.animaapp.com/mo863n0tfCwuCJ/img/ics-png-2-1.png"
              />
            ...
            <div className="flex flex-wrap gap-8 lg:gap-12 xl:gap-16 flex-1 lg:justify-end">
              ...
              <div className="flex flex-col gap-4 min-w-[180px] max-w-[237px]">
                ...
                {popularCategories.map((cat, idx) => (
                  <div key={idx} className="[font-family:'Poppins',Helvetica] font-medium text-white text-base leading-6 cursor-pointer hover:opacity-80 transition-opacity">
                    {cat}
                  </div>
                ))}
              </div>
