    ...
    <div className="bg-white overflow-x-hidden w-full">
      ...
      <section className="w-full bg-white py-14 md:py-20">
        <div className="max-w-[1728px] mx-auto px-6 md:px-16 lg:px-24">
          ...
          {/* Infinite marquee — two identical strips side by side, animates one strip-width */}
          <style>{`
          ...
          >
            <div className="marquee-track">
              ...
              {/* Duplicate — must follow immediately for seamless loop */}
              <div className="marquee-strip">
                <img
                  className="h-auto flex-shrink-0"
                  style={{ width: "100vw", minWidth: "900px", maxWidth: "1728px", display: "block" }}
      ...
      {/* ══════════════════════════════════════
          3. CONFERENCE CTA (ICMLBDA 2026 Banner)
          ══════════════════════════════════════ */}
